...
1. **AvitoTech.** Официальный сайт, блок «AvitoTech в цифрах»: аудитория и активные объявления. [avito.tech](https://avito.tech/). Повторная проверка: 16.09.2026.
2. **OLX Group. About us.** Описание платформ и рыночной ниши. [olxgroup.com/about-us](https://www.olxgroup.com/about-us/).
3. **Методические указания к заданию.** Требования к теме, аудитории и MVP. [init/highload](https://github.com/init/highload/blob/main/homework_architecture.md).

Первичная дата обращения к источникам: 10.09.2026. Источник [1] повторно проверен 16.09.2026.
